...
[![Build Status](https://travis-ci.com/itetcetera/protoreflect.svg?branch=master)](https://travis-ci.com/github/itetcetera/protoreflect/branches)
[![Go Report Card](https://goreportcard.com/badge/github.com/itetcetera/protoreflect)](https://goreportcard.com/report/github.com/itetcetera/protoreflect)
...
[![GoDoc](https://godoc.org/github.com/itetcetera/protoreflect?status.svg)](https://godoc.org/github.com/itetcetera/protoreflect)

----
## Descriptors: The Language Model of Protocol Buffers

```go
import "github.com/itetcetera/protoreflect/desc"
```
...
*[Read more ≫](https://godoc.org/github.com/itetcetera/protoreflect/desc)*

```go
import "github.com/itetcetera/protoreflect/desc/protoparse"
```
...
*[Read more ≫](https://godoc.org/github.com/itetcetera/protoreflect/desc/protoparse)*

```go
import "github.com/itetcetera/protoreflect/desc/protoprint"
```
...
*[Read more ≫](https://godoc.org/github.com/itetcetera/protoreflect/desc/protoprint)*

```go
import "github.com/itetcetera/protoreflect/desc/builder"
```
...
*[Read more ≫](https://godoc.org/github.com/itetcetera/protoreflect/desc/builder)*

----
## Dynamic Messages and Stubs

```go
import "github.com/itetcetera/protoreflect/dynamic"
```
...
```go
import "github.com/itetcetera/protoreflect/dynamic/grpcdynamic"
```
...
*[Read more ≫](https://godoc.org/github.com/itetcetera/protoreflect/dynamic/grpcdynamic)*

----
## gRPC Server Reflection

```go
import "github.com/itetcetera/protoreflect/grpcreflect"
```
...
*[Read more ≫](https://godoc.org/github.com/itetcetera/protoreflect/grpcreflect)*
