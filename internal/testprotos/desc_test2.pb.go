...
import (
	...
	nopkg "github.com/itetcetera/protoreflect/internal/testprotos/nopkg"
	pkg "github.com/itetcetera/protoreflect/internal/testprotos/pkg"
...
type Whatchamacallit struct {
	...
	Foos *pkg.Foo `protobuf:"varint,1,req,name=foos,enum=itetcetera.protoreflect.desc.Foo" json:"foos,omitempty"`
}
...
var file_desc_test2_proto_goTypes = []interface{}{
	...
	(pkg.Foo)(0),                      // 8: itetcetera.protoreflect.desc.Foo
	(*pkg.Bar)(nil),                   // 9: itetcetera.protoreflect.desc.Bar
...
var file_desc_test2_proto_depIdxs = []int32{
	...
	8,  // 6: testprotos.Whatchamacallit.foos:type_name -> itetcetera.protoreflect.desc.Foo
	9,  // 7: testprotos.Whatzit.gyzmeau:type_name -> itetcetera.protoreflect.desc.Bar
