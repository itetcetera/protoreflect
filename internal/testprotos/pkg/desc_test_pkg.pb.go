...
type Bar struct {
	...
	Baz []Foo `protobuf:"varint,1,rep,name=baz,enum=itetcetera.protoreflect.desc.Foo" json:"baz,omitempty"`
}
...
var file_pkg_desc_test_pkg_proto_goTypes = []interface{}{
	(Foo)(0),    // 0: itetcetera.protoreflect.desc.Foo
	(*Bar)(nil), // 1: itetcetera.protoreflect.desc.Bar
}
var file_pkg_desc_test_pkg_proto_depIdxs = []int32{
	0, // 0: itetcetera.protoreflect.desc.Bar.baz:type_name -> itetcetera.protoreflect.desc.Foo
